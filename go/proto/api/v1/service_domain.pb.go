...
type RegisterDomainRequest struct {
	...
	ActiveClustersByRegion           map[string]string                  `protobuf:"bytes,14,rep,name=active_clusters_by_region,json=activeClustersByRegion,proto3" json:"active_clusters_by_region,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // Deprecated: Do not use.
...
type FailoverDomainRequest struct {
	...
	FailoverTimeout *types.Duration `protobuf:"bytes,50,opt,name=failover_timeout,json=failoverTimeout,proto3" json:"failover_timeout,omitempty"`
	...
	SkipDestinationClusterCheck bool     `protobuf:"varint,60,opt,name=skip_destination_cluster_check,json=skipDestinationClusterCheck,proto3" json:"skip_destination_cluster_check,omitempty"`
	XXX_NoUnkeyedLiteral        struct{} `json:"-"`
	XXX_unrecognized            []byte   `json:"-"`
	XXX_sizecache               int32    `json:"-"`
}
...
func (m *FailoverDomainRequest) GetFailoverTimeout() *types.Duration {
	if m != nil {
		return m.FailoverTimeout
	}
	return nil
...
func (m *FailoverDomainRequest) GetSkipDestinationClusterCheck() bool {
	if m != nil {
		return m.SkipDestinationClusterCheck
	}
	return false
}
...
var fileDescriptor_2e37d15268893114 = []byte{
	...
	,
}
...
func (m *FailoverDomainRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.SkipDestinationClusterCheck {
		i--
		if m.SkipDestinationClusterCheck {
			dAtA[i] = 1
		} else {
...
func (m *FailoverDomainRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 60:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SkipDestinationClusterCheck", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SkipDestinationClusterCheck = bool(v != 0)
		default:
			iNdEx = preIndex
			skippy, err := skipServiceDomain(dAtA[iNdEx:])
			if err != nil {
