...
const (
	// Unknown or unspecified failure category. Treated like FAILURE_CATEGORY_STANDARD.
	FailureCategory_FAILURE_CATEGORY_INVALID FailureCategory = 0
	// Indicates the failure is expected due to a polling-style activity. Clients should avoid logging or emitting metrics
	// for failures of this category.
	FailureCategory_FAILURE_CATEGORY_POLL FailureCategory = 1
	// Default behavior for a failure. Whether the failure is retried depends on the RetryPolicy.
	FailureCategory_FAILURE_CATEGORY_STANDARD FailureCategory = 2
	// Indicates that the failure should not be retried, regardless of the RetryPolicy.
	FailureCategory_FAILURE_CATEGORY_FATAL FailureCategory = 3
)

var FailureCategory_name = map[int32]string{
	0: "FAILURE_CATEGORY_INVALID",
	1: "FAILURE_CATEGORY_POLL",
	2: "FAILURE_CATEGORY_STANDARD",
	3: "FAILURE_CATEGORY_FATAL",
}

var FailureCategory_value = map[string]int32{
	"FAILURE_CATEGORY_INVALID":  0,
	"FAILURE_CATEGORY_POLL":     1,
	"FAILURE_CATEGORY_STANDARD": 2,
	"FAILURE_CATEGORY_FATAL":    3,
}

func (x FailureCategory) String() string {
	return proto.EnumName(FailureCategory_name, int32(x))
}
...
type Failure struct {
	...
	Options              *FailureOptions `protobuf:"bytes,3,opt,name=options,proto3" json:"options,omitempty"`
	XXX_NoUnkeyedLiteral struct{}        `json:"-"`
	XXX_unrecognized     []byte          `json:"-"`
	XXX_sizecache        int32           `json:"-"`
}
...
func (m *Failure) GetOptions() *FailureOptions {
	if m != nil {
		return m.Options
	}
	return nil
...
type FailureOptions struct {
	FailureCategory FailureCategory `protobuf:"varint,1,opt,name=failure_category,json=failureCategory,proto3,enum=uber.cadence.api.v1.FailureCategory" json:"failure_category,omitempty"`
	// If set, overrides the next retry interval calculated by the RetryPolicy for this failure. This allows activity
	// implementations to control the retry interval on a per failure basis.
	// This value does not influence whether or not the activity will be retried. That is determined by the RetryPolicy
	// and the failure's category.
	NextRetryInterval    *types.Duration `protobuf:"bytes,2,opt,name=next_retry_interval,json=nextRetryInterval,proto3" json:"next_retry_interval,omitempty"`
	XXX_NoUnkeyedLiteral struct{}        `json:"-"`
	XXX_unrecognized     []byte          `json:"-"`
	XXX_sizecache        int32           `json:"-"`
}

func (m *FailureOptions) Reset()         { *m = FailureOptions{} }
func (m *FailureOptions) String() string { return proto.CompactTextString(m) }
func (*FailureOptions) ProtoMessage()    {}
func (*FailureOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_0ff151d4a308b356, []int{5}
}
func (m *FailureOptions) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *FailureOptions) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_FailureOptions.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *FailureOptions) XXX_Merge(src proto.Message) {
	xxx_messageInfo_FailureOptions.Merge(m, src)
}
func (m *FailureOptions) XXX_Size() int {
	return m.Size()
}
func (m *FailureOptions) XXX_DiscardUnknown() {
	xxx_messageInfo_FailureOptions.DiscardUnknown(m)
}

var xxx_messageInfo_FailureOptions proto.InternalMessageInfo

func (m *FailureOptions) GetFailureCategory() FailureCategory {
	if m != nil {
		return m.FailureCategory
	}
	return FailureCategory_FAILURE_CATEGORY_INVALID
}

func (m *FailureOptions) GetNextRetryInterval() *types.Duration {
	if m != nil {
		return m.NextRetryInterval
	}
	return nil
}
...
func (m *RetryPolicy) GetJitterCoefficient() float64 {
	if m != nil {
		return m.JitterCoefficient
	}
	return 0
}
...
func init() {
	proto.RegisterEnum("uber.cadence.api.v1.FailureCategory", FailureCategory_name, FailureCategory_value)
	...
	proto.RegisterType((*FailureOptions)(nil), "uber.cadence.api.v1.FailureOptions")
...
var fileDescriptor_0ff151d4a308b356 = []byte{
	...
	,
}
...
func (m *FailureOptions) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *FailureOptions) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *FailureOptions) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.NextRetryInterval != nil {
		{
			size, err := m.NextRetryInterval.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.FailureCategory != 0 {
		i = encodeVarintCommon(dAtA, i, uint64(m.FailureCategory))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *RetryPolicy) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.JitterCoefficient != 0 {
		i -= 8
		encoding_binary.LittleEndian.PutUint64(dAtA[i:], uint64(math.Float64bits(float64(m.JitterCoefficient))))
		i--
		dAtA[i] = 0x39
	}
...
func (m *FailureOptions) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.FailureCategory != 0 {
		n += 1 + sovCommon(uint64(m.FailureCategory))
	}
	if m.NextRetryInterval != nil {
		l = m.NextRetryInterval.Size()
		n += 1 + l + sovCommon(uint64(l))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
...
func (m *FailureOptions) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: FailureOptions: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FailureOptions: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field FailureCategory", wireType)
			}
			m.FailureCategory = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.FailureCategory |= FailureCategory(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field NextRetryInterval", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.NextRetryInterval == nil {
				m.NextRetryInterval = &types.Duration{}
			}
			if err := m.NextRetryInterval.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *RetryPolicy) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 1 {
				return fmt.Errorf("proto: wrong wireType = %d for field JitterCoefficient", wireType)
			}
			var v uint64
			if (iNdEx + 8) > l {
				return io.ErrUnexpectedEOF
			...
			v = uint64(encoding_binary.LittleEndian.Uint64(dAtA[iNdEx:]))
			iNdEx += 8
			m.JitterCoefficient = float64(math.Float64frombits(v))
		default:
			iNdEx = preIndex
			skippy, err := skipCommon(dAtA[iNdEx:])
			if err != nil {
