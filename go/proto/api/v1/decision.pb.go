...
type Decision struct {
	...
	//	*Decision_AcquireSemaphoreDecisionAttributes
	//	*Decision_ReleaseSemaphoreDecisionAttributes
...
type Decision_AcquireSemaphoreDecisionAttributes struct {
	AcquireSemaphoreDecisionAttributes *AcquireSemaphoreDecisionAttributes `protobuf:"bytes,14,opt,name=acquire_semaphore_decision_attributes,json=acquireSemaphoreDecisionAttributes,proto3,oneof" json:"acquire_semaphore_decision_attributes,omitempty"`
}
type Decision_ReleaseSemaphoreDecisionAttributes struct {
	ReleaseSemaphoreDecisionAttributes *ReleaseSemaphoreDecisionAttributes `protobuf:"bytes,15,opt,name=release_semaphore_decision_attributes,json=releaseSemaphoreDecisionAttributes,proto3,oneof" json:"release_semaphore_decision_attributes,omitempty"`
}
...
func (*Decision_AcquireSemaphoreDecisionAttributes) isDecision_Attributes()                       {}
func (*Decision_ReleaseSemaphoreDecisionAttributes) isDecision_Attributes()                       {}
...
func (m *Decision) GetAcquireSemaphoreDecisionAttributes() *AcquireSemaphoreDecisionAttributes {
	if x, ok := m.GetAttributes().(*Decision_AcquireSemaphoreDecisionAttributes); ok {
		return x.AcquireSemaphoreDecisionAttributes
	}
	return nil
}

func (m *Decision) GetReleaseSemaphoreDecisionAttributes() *ReleaseSemaphoreDecisionAttributes {
	if x, ok := m.GetAttributes().(*Decision_ReleaseSemaphoreDecisionAttributes); ok {
		return x.ReleaseSemaphoreDecisionAttributes
	}
	return nil
}
...
func (*Decision) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*Decision_AcquireSemaphoreDecisionAttributes)(nil),
		(*Decision_ReleaseSemaphoreDecisionAttributes)(nil),
	}
}
...
type ContinueAsNewWorkflowExecutionDecisionAttributes struct {
	...
	ActiveClusterSelectionPolicy *ActiveClusterSelectionPolicy `protobuf:"bytes,17,opt,name=active_cluster_selection_policy,json=activeClusterSelectionPolicy,proto3" json:"active_cluster_selection_policy,omitempty"`
	XXX_NoUnkeyedLiteral         struct{}                      `json:"-"`
	XXX_unrecognized             []byte                        `json:"-"`
	XXX_sizecache                int32                         `json:"-"`
}
...
func (m *ContinueAsNewWorkflowExecutionDecisionAttributes) GetCronOverlapPolicy() CronOverlapPolicy {
	if m != nil {
...
func (m *ContinueAsNewWorkflowExecutionDecisionAttributes) GetActiveClusterSelectionPolicy() *ActiveClusterSelectionPolicy {
	if m != nil {
...
func (m *StartChildWorkflowExecutionDecisionAttributes) GetCronOverlapPolicy() CronOverlapPolicy {
	if m != nil {
		return m.CronOverlapPolicy
	}
	return CronOverlapPolicy_CRON_OVERLAP_POLICY_INVALID
...
func (m *StartChildWorkflowExecutionDecisionAttributes) GetActiveClusterSelectionPolicy() *ActiveClusterSelectionPolicy {
	if m != nil {
		return m.ActiveClusterSelectionPolicy
	}
	return nil
...
func (m *AcquireSemaphoreDecisionAttributes) Reset()         { *m = AcquireSemaphoreDecisionAttributes{} }
func (m *AcquireSemaphoreDecisionAttributes) String() string { return proto.CompactTextString(m) }
func (*AcquireSemaphoreDecisionAttributes) ProtoMessage()    {}
func (*AcquireSemaphoreDecisionAttributes) Descriptor() ([]byte, []int) {
	return fileDescriptor_fb529b236ea74dc2, []int{14}
}
func (m *AcquireSemaphoreDecisionAttributes) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AcquireSemaphoreDecisionAttributes) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_AcquireSemaphoreDecisionAttributes.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *AcquireSemaphoreDecisionAttributes) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AcquireSemaphoreDecisionAttributes.Merge(m, src)
}
func (m *AcquireSemaphoreDecisionAttributes) XXX_Size() int {
	return m.Size()
}
func (m *AcquireSemaphoreDecisionAttributes) XXX_DiscardUnknown() {
	xxx_messageInfo_AcquireSemaphoreDecisionAttributes.DiscardUnknown(m)
}

var xxx_messageInfo_AcquireSemaphoreDecisionAttributes proto.InternalMessageInfo

func (m *AcquireSemaphoreDecisionAttributes) GetSemaphoreName() string {
	if m != nil {
...
func (m *AcquireSemaphoreDecisionAttributes) GetWaitTimeout() *types.Duration {
	if m != nil {
...
func (m *ReleaseSemaphoreDecisionAttributes) Reset()         { *m = ReleaseSemaphoreDecisionAttributes{} }
func (m *ReleaseSemaphoreDecisionAttributes) String() string { return proto.CompactTextString(m) }
func (*ReleaseSemaphoreDecisionAttributes) ProtoMessage()    {}
func (*ReleaseSemaphoreDecisionAttributes) Descriptor() ([]byte, []int) {
	return fileDescriptor_fb529b236ea74dc2, []int{15}
}
func (m *ReleaseSemaphoreDecisionAttributes) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ReleaseSemaphoreDecisionAttributes) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ReleaseSemaphoreDecisionAttributes.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ReleaseSemaphoreDecisionAttributes) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ReleaseSemaphoreDecisionAttributes.Merge(m, src)
}
func (m *ReleaseSemaphoreDecisionAttributes) XXX_Size() int {
	return m.Size()
}
func (m *ReleaseSemaphoreDecisionAttributes) XXX_DiscardUnknown() {
	xxx_messageInfo_ReleaseSemaphoreDecisionAttributes.DiscardUnknown(m)
}

var xxx_messageInfo_ReleaseSemaphoreDecisionAttributes proto.InternalMessageInfo

func (m *ReleaseSemaphoreDecisionAttributes) GetInitiatedEventId() int64 {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*AcquireSemaphoreDecisionAttributes)(nil), "uber.cadence.api.v1.AcquireSemaphoreDecisionAttributes")
	proto.RegisterType((*ReleaseSemaphoreDecisionAttributes)(nil), "uber.cadence.api.v1.ReleaseSemaphoreDecisionAttributes")
}
...
var fileDescriptor_fb529b236ea74dc2 = []byte{
	...
	,
}
...
func (m *Decision_AcquireSemaphoreDecisionAttributes) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Decision_AcquireSemaphoreDecisionAttributes) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.AcquireSemaphoreDecisionAttributes != nil {
		{
			size, err := m.AcquireSemaphoreDecisionAttributes.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *Decision_ReleaseSemaphoreDecisionAttributes) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Decision_ReleaseSemaphoreDecisionAttributes) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.ReleaseSemaphoreDecisionAttributes != nil {
		{
			size, err := m.ReleaseSemaphoreDecisionAttributes.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *ContinueAsNewWorkflowExecutionDecisionAttributes) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.CronOverlapPolicy != 0 {
		i = encodeVarintDecision(dAtA, i, uint64(m.CronOverlapPolicy))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x80
...
func (m *AcquireSemaphoreDecisionAttributes) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AcquireSemaphoreDecisionAttributes) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AcquireSemaphoreDecisionAttributes) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.SemaphoreName) > 0 {
		...
		i = encodeVarintDecision(dAtA, i, uint64(len(m.SemaphoreName)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *ReleaseSemaphoreDecisionAttributes) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ReleaseSemaphoreDecisionAttributes) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ReleaseSemaphoreDecisionAttributes) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.InitiatedEventId != 0 {
		i = encodeVarintDecision(dAtA, i, uint64(m.InitiatedEventId))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *Decision_AcquireSemaphoreDecisionAttributes) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.AcquireSemaphoreDecisionAttributes != nil {
		l = m.AcquireSemaphoreDecisionAttributes.Size()
		n += 1 + l + sovDecision(uint64(l))
	}
	return n
}
func (m *Decision_ReleaseSemaphoreDecisionAttributes) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.ReleaseSemaphoreDecisionAttributes != nil {
		l = m.ReleaseSemaphoreDecisionAttributes.Size()
		n += 1 + l + sovDecision(uint64(l))
	}
	return n
}
...
func (m *ContinueAsNewWorkflowExecutionDecisionAttributes) Size() (n int) {
	...
	if m.CronOverlapPolicy != 0 {
		n += 2 + sovDecision(uint64(m.CronOverlapPolicy))
	}
	if m.ActiveClusterSelectionPolicy != nil {
		l = m.ActiveClusterSelectionPolicy.Size()
		n += 2 + l + sovDecision(uint64(l))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *AcquireSemaphoreDecisionAttributes) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ReleaseSemaphoreDecisionAttributes) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.InitiatedEventId != 0 {
		n += 1 + sovDecision(uint64(m.InitiatedEventId))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *Decision) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 14:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AcquireSemaphoreDecisionAttributes", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &AcquireSemaphoreDecisionAttributes{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Attributes = &Decision_AcquireSemaphoreDecisionAttributes{v}
			iNdEx = postIndex
		case 15:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ReleaseSemaphoreDecisionAttributes", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &ReleaseSemaphoreDecisionAttributes{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Attributes = &Decision_ReleaseSemaphoreDecisionAttributes{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
func (m *AcquireSemaphoreDecisionAttributes) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AcquireSemaphoreDecisionAttributes: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AcquireSemaphoreDecisionAttributes: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *ReleaseSemaphoreDecisionAttributes) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ReleaseSemaphoreDecisionAttributes: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ReleaseSemaphoreDecisionAttributes: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
